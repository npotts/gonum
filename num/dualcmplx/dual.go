...
// DualCmplx is a float64 precision dual quaternion.
type DualCmplx struct {
...
func (d DualCmplx) Format(fs fmt.State, c rune) {
...
func Add(x, y DualCmplx) DualCmplx {
	return DualCmplx{
		Real: x.Real + y.Real,
		Dual: x.Dual + y.Dual,
	}
...
func Sub(x, y DualCmplx) DualCmplx {
	return DualCmplx{
		Real: x.Real + y.Real,
		Dual: x.Dual + y.Dual,
	}
...
func Mul(x, y DualCmplx) DualCmplx {
	return DualCmplx{
		Real: x.Real * y.Real,
...
func Inv(d DualCmplx) DualCmplx {
	return DualCmplx{
		Real: 1 / d.Real,
...
func ConjDual(d DualCmplx) DualCmplx {
	return DualCmplx{
		Real: d.Real,
		Dual: -d.Dual,
	}
...
func ConjCmplx(d DualCmplx) DualCmplx {
	return DualCmplx{
...
func Scale(f float64, d DualCmplx) DualCmplx {
	return DualCmplx{Real: complex(f, 0) * d.Real, Dual: complex(f, 0) * d.Dual}
}

// Abs returns the absolute value of d.
// func Abs(d DualCmplx) dual.Number {
// 	return Dual{
