...
func dSinh(x complex128) complex128  { return cmplx.Cosh(x) }
func dCosh(x complex128) complex128  { return cmplx.Sinh(x) }
func dTanh(x complex128) complex128  { return sech(x) * sech(x) }
...
func dSqrt(x complex128) complex128   { return 0.5 * cmplx.Sqrt(x) }
