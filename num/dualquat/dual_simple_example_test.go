...
func Example_displace() {
	...
	p := dualquat.DualQuat{Real: quat.Quat{Real: 1}, Dual: quat.Quat{Imag: 3, Jmag: 4, Kmag: 5}}

	// Displacement vector, half [4, 2, 6], in the dual imaginary vector.
	d := dualquat.DualQuat{Real: quat.Quat{Real: 1}, Dual: quat.Quat{Imag: 2, Jmag: 1, Kmag: 3}}
...
func Example_rotate() {
	...
	r := dualquat.DualQuat{Real: quat.Quat{Real: 0, Imag: 1}}
